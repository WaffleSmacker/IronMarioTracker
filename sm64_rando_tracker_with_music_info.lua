...
while true do
    ...
    local previous_music = music_name
    local music_name = getSongName(displayData.music)

    -- Handles Music Stuff
    if displayData.music and previous_music ~= music_name then
        saveMusic(music_name)
    end
    gui.text(20, screen_height - 40, music_name)
    ...
    local starTrackingStartLine = 10 + warpCountLines  -- Ensure star tracking starts after warp mapping
    ...
    -- gui.text(20, 730, "Music: " .. music_name)
    -- gui.text(20, 530, "Song Name: " .. getSongName(displayData.music))
